...
const appVersons_router_1 = __importDefault(require("./appVersons.router"));
...
class DashboardRoutes {
    constructor(app) {
        ...
        app.use("/api/v1/dashboard/app-versions", authenticate_controller_1.protectAdmin, appVersons_router_1.default);
    }
}

...
router.post("/", uploadFiles_1.upload.single("image"), (0, setImageUrl_1.setImageUrl)(), (0, validationMiddleware_1.validateData)(GroupsChatValidator_1.addGroupChatValidator), GroupsChat_controller_1.createGroupChat);

...
router.put("/", uploadFiles_1.upload.single("image"), (0, validationMiddleware_1.validateData)(profileValidator_1.updateProfileValidator), profile_controller_1.updateProfileData);

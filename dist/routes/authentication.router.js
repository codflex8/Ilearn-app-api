...
router.post("/signup", uploadFiles_1.upload.single("image"), (0, setImageUrl_1.setImageUrl)(), (0, validationMiddleware_1.validateData)(AuthValidator_1.signUpValidator), authentication_controller_1.signup);

...
exports.getAppVersions = exports.getAppLinks = void 0;
...
exports.getAppVersions = (0, express_async_handler_1.default)(async (req, res, next) => {
    var _a, _b;
    const appLinks = await AppLinks_model_1.AppLinks.findOne({ where: {} });
    res.status(200).json({
        appLinks: {
            androidVersion: (_a = appLinks === null || appLinks === void 0 ? void 0 : appLinks.androidVersion) !== null && _a !== void 0 ? _a : "",
            appleVersion: (_b = appLinks === null || appLinks === void 0 ? void 0 : appLinks.appleVersion) !== null && _b !== void 0 ? _b : "",
        },
    });
});
